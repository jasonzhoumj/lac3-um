...
import com.linkallcloud.comm.web.exception.LoginException;
...
import com.linkallcloud.www.utils.WebUtils;
...
public class LoginController {
	...
	private SessionUser assembleSessionUser(Trace t, Account account) {
		User dbUser = khUserManager.fecthByAccount(t, account.getAccount());
