...
import com.linkallcloud.query.Orderby;
import com.linkallcloud.query.Query;
import com.linkallcloud.query.rule.BeginsWith;
import com.linkallcloud.query.rule.Equal;
import com.linkallcloud.query.rule.Less;
...
public class AreaService extends TreeDomainService<Long, Area, IAreaDao> implements IAreaService {
...
//	@Override
//    public List<Area> findAreasByParent(Trace t, Long parentId) {
